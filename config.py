...
class Config(object):
    SECRET_KEY = os.environ.get('SECRET_KEY') or 'efGjSs67OY04Xbycvfh4'
    SSL_DISABLE = False
...
class TestingConfig(Config):
    TESTING = True
    LOGIN_DISABLED = False # is set to True if TESTING == True
...
class ProductionConfig(Config):
    ...
    def init_app(cls, app):
        ...
        mail_handler = SMTPHandler(
            ...
            fromaddr=cls.SMR_MAIL_SENDER,
            toaddrs=[cls.SMR_ADMIN],
            subject=cls.SMR_MAIL_SUBJECT_PREFIX + ' Application Error',
